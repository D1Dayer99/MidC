                            ...
                            <v-tooltip bottom>
                                <template v-slot:activator="{on,attrs}">
                                    <button
                                        ...
                                        v-bind="attrs"
                                        v-on="on">
                                        <v-icon class="piano-icon">mdi-login</v-icon>
                                    </button>
                                </template>
                                <span>Log In</span>
                            </v-tooltip>
                            ...
                            <v-tooltip bottom>
                                <template v-slot:activator="{on,attrs}">
                                    <button
                                        ...
                                        v-bind="attrs"
                                        v-on="on">
                                        <v-icon class="piano-icon">mdi-account-plus</v-icon>
                                    </button>
                                </template>
    ...
    methods:{
        ...
        handleFileChange(event) {
            ...
            axios.post('/api/upload', formData).then(response => {
                ...
                this.$store.commit(playlistState + "/" + ADD_SONG, song);
                this.$store.commit(playlistState + "/" + SET_CURRENT_SONG, song)
                this.$store.dispatch(playlistState + "/" + changeSong)
            }).catch(error => {
